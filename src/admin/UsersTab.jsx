  ...
  return (
    <>
      ...
      <div className="admin-charts">
        <UsersTable />
        <ChartBlock title="Daily Active Users" entries={stats.dailyActiveUsers} xKey="date" yTitle="Users" color={LINE_COLOR} />
        <ChartBlock title="Monthly Active Users" entries={stats.monthlyActiveUsers} xKey="month" yTitle="Users" color="#4ECDC4" />
        <ChartBlock title="New Signups Per Day" entries={stats.newSignupsPerDay} xKey="date" yTitle="Signups" color="#74b9ff" />
      </div>
    </>
  );
}
