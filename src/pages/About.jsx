      ...
      <div className="container py-5">
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-10 text-white">
            ...
            <div className="card shadow-soft border-0 mb-4" style={{backgroundColor: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)'}}>
              <div className="card-body p-4">
                <p className="lead text-center mb-0 text-white">
